...
$$
BC = \sqrt{\frac{2 \wrapParens{1-\rho}}{\ssiz}} \qnorm{1 - \typeI/{\ssiz \choose 2}},
$$
...
$\ssiz \choose 2$ pairwise comparison tests. 
...
\includegraphics[width=0.975\textwidth,height=0.646\textwidth]{figure/posthoc_null_basic_qq_plot-1} \caption[The quantiles of the range of \txtSR from 10,000 simulations are plotted against a transformed Tukey distribution, $\sqrt{(1-\rho)/\ssiz}\, \qtuk{\cdot}{\nlatf}{\infty}$]{The quantiles of the range of \txtSR from 10,000 simulations are plotted against a transformed Tukey distribution, $\sqrt{(1-\rho)/\ssiz}\, \qtuk{\cdot}{\nlatf}{\infty}$. The points show little deviation from the plotted $y=x$ line. }\label{fig:null_basic_qq_plot}
\end{figure}
...
\item Should we expect the Tukey HSD cutoff and the Bonferroni Cutoff to 
  ...
  certain conditions?
\item Can the power of the test be improved?
\end{enumerate}
